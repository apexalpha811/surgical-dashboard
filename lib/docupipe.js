(function(){
  ...
  function activeModuleDraft() {
    ...
    const forceSchemaId = Boolean($("docuForceSchemaId") && $("docuForceSchemaId").checked);
    return {
      ...module,
  ...
  function populateEditor() {
    ...
    if ($("docuForceSchemaId")) $("docuForceSchemaId").checked = false;
    ...
    setText("docuSchemaState", "automatic");
  }
  ...
  async function uploadDocument() {
    ...
    const result = await api("/api/docupipe/upload", {
      ...
      body: JSON.stringify({
        moduleId: module.id,
        schemaId: module.forceSchemaId ? module.docupipeSchemaId : "",
        forceSchemaId: module.forceSchemaId,
        fileName: file.name,
